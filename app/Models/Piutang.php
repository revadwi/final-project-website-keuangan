...
class Piutang extends Model
{
    ...
    protected $appends = ['nominal_akhir', 'nominal_dibayarkan', 'nominal_sisa', 'pendapatan_bunga'];
    ...
    {
        return $this->hasMany(Transaksi::class, 'piutang_id');
    }
    ...
    public function getPendapatanBungaAttribute()
    {
    ...
    {
        return collect($this->transaksis)->where('jenis_transaksi', 'Pemasukan')->sum('jumlah');
    }
