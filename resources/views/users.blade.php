        ...
        <main class="main-content">
            ...
            <header class="header">
                <div class="header-titles">
                    ...
                    <p>Halaman fitur User Management</p>
                </div>
            ...
            <div id="view-users" class="view-section active admin-only-view" style="display: block; padding: 20px; background: white; border-radius: 12px; margin-top: 20px;">
                <h2>Manajemen Pengguna</h2>
                <p style="color: #64748b; margin-top: 5px;">Atur siapa saja yang memiliki akses ke sistem ini.</p>
                <div style="margin-top: 20px; background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 8px; padding: 15px;">
                    <ul style="list-style: none; display: flex; flex-direction: column; gap: 15px;">
                        <li style="display: flex; justify-content: space-between; align-items: center; padding-bottom: 15px; border-bottom: 1px solid #e2e8f0;">
                            <div>
                                <strong style="display: block; font-size: 15px;">Azza Admin</strong>
                                <span style="font-size: 13px; color: #64748b;">admin@jobnation.id</span>
                            </div>
                            <span style="background: #dbeafe; color: #1e40af; padding: 4px 10px; border-radius: 20px; font-size: 12px; font-weight: 600;">Administrator</span>
                        </li>
                        <li style="display: flex; justify-content: space-between; align-items: center;">
                            <div>
                                <strong style="display: block; font-size: 15px;">Staff Keuangan</strong>
                                <span style="font-size: 13px; color: #64748b;">staff@jobnation.id</span>
                            </div>
                            <span style="background: #f1f5f9; color: #475569; padding: 4px 10px; border-radius: 20px; font-size: 12px; font-weight: 600;">Viewer</span>
                        </li>
                    </ul>
                    <button type="button" style="margin-top: 15px; width: 100%; padding: 10px; background: transparent; border: 1px dashed #cbd5e1; color: #475569; border-radius: 6px; cursor: pointer; font-weight: 500;">+ Tambah Pengguna Baru</button>
                </div>
            </div>
