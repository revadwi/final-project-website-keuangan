    ...
    <div class="dashboard-container">
        ...
        <main class="main-content">
            ...
            <div id="view-pemasukan" class="view-section active" style="display: block; padding: 20px; background: white; border-radius: 12px; margin-top: 20px;">
                ...
                <p style="color: #64748b; margin-top: 5px;">Semua data pemasukan dana perusahaan.</p>
                <div class="transactions-list" style="margin-top:20px; background: #f8fafc; padding: 15px; border-radius: 8px;">
                    <table style="width:100%; text-align:left; border-collapse: collapse;">
                        ...
                        <tr style="border-bottom: 1px solid #e2e8f0;">
                            <td style="padding: 12px 10px;">01 Sept 2026</td>
                            <td style="padding: 12px 10px;">Pendapatan Proyek IT (Klien A)</td>
                            <td style="padding: 12px 10px; color: #059669; font-weight: 600;">+ Rp 25.000.000</td>
                        </tr>
                        <tr>
                            <td style="padding: 12px 10px;">28 Agu 2026</td>
                            <td style="padding: 12px 10px;">Pencairan Invoice #INV-204</td>
                            <td style="padding: 12px 10px; color: #059669; font-weight: 600;">+ Rp 12.500.000</td>
                        </tr>
                    </table>
                </div>
            </div>
