    ...
    <div class="dashboard-container">
        ...
        <main class="main-content">
            ...
            <div id="view-laporan" class="view-section active" style="display: block; padding: 20px; background: white; border-radius: 12px; margin-top: 20px;">
                ...
                <p style="color: #64748b; margin-top: 5px;">Unduh rekapitulasi data keuangan.</p>
                <div style="margin-top: 25px; display: flex; gap: 15px;">
                    <button type="button" id="btn-download-pdf" class="action-btn" style="padding: 12px 20px; background: #1e293b; color: white; border: none; border-radius: 6px; font-weight: 500; cursor: pointer; display: flex; align-items: center; gap: 8px;">
                        <i class="ri-file-pdf-line"></i> Download Laporan Agustus (.PDF)
                    </button>
                    <button type="button" id="btn-download-excel" class="action-btn" style="padding: 12px 20px; background: #059669; color: white; border: none; border-radius: 6px; font-weight: 500; cursor: pointer; display: flex; align-items: center; gap: 8px;">
                        <i class="ri-file-excel-line"></i> Export Data Transaksi (.XLSX)
                    </button>
                </div>
            </div>
