...
<div class="view-section active" style="display: block; padding: 20px; background: white; border-radius: 12px; margin-top: 20px;">
                ...
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px; flex-wrap: wrap; gap: 10px;">
                    ...
                    <div style="display: flex; gap: 10px; flex-wrap: wrap;">
                        <a href="{{ route('akun.export') }}" class="btn-primary" style="background-color: #10b981; text-decoration: none;"><i class="ri-file-excel-line"></i> Export Excel</a>
    ...
    <div id="modalImport" class="modal">
        <div class="modal-content">
            ...
            <div style="margin-top: 15px; margin-bottom: 15px;">
                ...
                <a href="{{ route('akun.template') }}" class="btn-primary" style="background-color: #10b981; text-decoration: none; display: inline-block; font-size: 14px;"><i class="ri-download-line"></i> Download Template</a>
            </div>
            <form action="{{ route('akun.import') }}" method="POST" enctype="multipart/form-data" style="margin-top: 20px;" onsubmit="var btn = this.querySelector('button[type=submit]'); btn.disabled = true; btn.innerHTML = 'Mengimpor...'; btn.style.opacity = '0.7';">
                @csrf
